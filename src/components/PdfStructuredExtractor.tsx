          ...
          <div className="border rounded-md p-3 space-y-3">
            ...
            {aiHeaders.length > 0 && (
              <AiResultsTable
                ...
                onChangeDescriptionFilter={handleDescriptionFilterChange}
                ...
                missingSelectedDatesCount={missingSelectedDatesCount}
                invalidRows={invalidRows}
                safeCurrentPage={safeCurrentPage}
                totalPages={totalPages}
                onPrevPage={() => setCurrentPage(safeCurrentPage - 1)}
                onNextPage={() => setCurrentPage(safeCurrentPage + 1)}
                onDownloadCsv={handleDownloadAiCSV}
                onRequestDeleteColumn={colIndex => {
                  setDeleteColumnIndex(colIndex);
