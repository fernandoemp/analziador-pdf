...
const AiResultsTable = ({
  ...
  return (
    <div className="border rounded-md">
      <div className="sticky top-0 z-10 bg-background p-3 border-b space-y-3">
        <div className="flex items-center justify-between gap-3">
      ...
      {!hasActiveFilters && aiRows.length > 0 && (
        <div className="flex items-center justify-end gap-2 text-xs text-muted-foreground p-3 border-t">
          <span>
